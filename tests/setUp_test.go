...
import (
	...
	db2 "github.com/xLeSHka/mentorLink/internal/connetions/db"
	minio2 "github.com/xLeSHka/mentorLink/internal/connetions/minio"
	"github.com/xLeSHka/mentorLink/internal/models"
	config2 "github.com/xLeSHka/mentorLink/internal/pkg/config"
	"github.com/xLeSHka/mentorLink/internal/repository"
	"github.com/xLeSHka/mentorLink/internal/repository/group"
	...
	http2 "github.com/xLeSHka/mentorLink/internal/transport/http"
	...
	jwt2 "github.com/xLeSHka/mentorLink/internal/transport/http/pkg/jwt"
	"gorm.io/gorm"
	"log"
	"net/http"
	"os"
